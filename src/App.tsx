            ...
            <table className="w-full max-w-[450px] border-collapse border border-white mb-6 text-center">
              ...
              <tbody>
                <tr className="bg-[#EEEEEE]">
                  <td className="border border-white p-1"><a href="https://github.com/MinhHK68/7-zip/releases/download/v1.0.0/7z_install-x64.exe" className="text-[#0000EE] hover:underline">Download</a></td>
